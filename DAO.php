...
class DAO implements iDAO {
     ...
     * @param $condicoes filtros aplicados no where (AND)
     */
    public function where(array $condicoes) {
        ...
        /**
     * Acrescenta um filtro condicional (where) na consulta sql
     * @param $condicoes filtros aplicados no where (OR)
     */
    public function whereOu(array $condicoes) {
        $this->sql .= ' WHERE ';

        //Adicionar todas as condicoes do array no SQL
        foreach ($condicoes as $condicao) {
            $this->sql .= $condicao . ' OR ';
        }
        //Remover o AND que esta sobrando
        $this->sql = rtrim($this->sql, ' OR ');
    }
      ...
      /**
     * Acrescenta um filtro condicional (ou) na consulta sql
     * @param $condicoes filtros aplicados no where (OR)
     */
    public function ou(array $condicoes) {
        $this->sql = '';
        //Adicionar todas as condicoes do array no SQL
        foreach ($condicoes as $condicao) {
            $this->sql .= $condicao . ' OR ';
